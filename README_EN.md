...
|---|---|---|
| [`cat-cafe-github-mr-review`](skills/cat-cafe-github-mr-review/SKILL.md) | Adversarial code review with dual-cat verification, producing line-level DiffNotes and blocking merge until closure | `@猫猫+MR链接` `GitHub MR 检视` `PR review` |
